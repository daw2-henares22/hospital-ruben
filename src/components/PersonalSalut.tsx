    ...
    return(
        <div>
            <div className="text-2xl pb-3">{props.personalSalut.nombre}</div>
              ...
              <button onClick={()=> setShowPopup(true)}><img src={`${props.personalSalut.imagen}`} alt="medicos" className="hover:scale-x-105 hover:scale-y-105 transition duration-150 w-80 rounded bg-cover"></img></button>
