    ...
    return(    
      <div className="p-4">
        <div className="bg-white p-6 rounded-lg border-2 border-gray-300">
          ...
          <button className="flex items-center mt-auto text-white bg-yellow-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-yellow-700 rounded">{props.especialidad.informacion}
