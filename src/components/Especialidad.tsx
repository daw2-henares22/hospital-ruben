...
export const Especialidad = (props: EspecialidadProps)=>{
    return(    
      <div className="p-4">
        <div className="bg-yellow-500 p-6 rounded-lg border-2 border-gray-300">
          <h2 className="text-sm tracking-widest mb-1 font-medium">{props.especialidad.apartado}</h2>
          <h1 className="sm:text-2xl md:text-2xl lg:text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">{props.especialidad.titulo}</h1>
          ...
          <button className="flex items-center mt-auto text-white bg-blue-600 border-0 py-2 px-4 w-full focus:outline-none hover:bg-blue-800 rounded">{props.especialidad.informacion}
