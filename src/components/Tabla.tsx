    ...
    return(    
      <div className="p-4">
        <div className="bg-yellow-500 p-6 rounded-lg border-2 border-gray-300">
          <h2 className="text-sm tracking-widest mb-1 font-medium">{props.apartado}</h2>
          <h1 className="text-5xl text-gray-900 pb-4 mb-4 border-b border-gray-200 leading-none">{props.titulo}</h1>
