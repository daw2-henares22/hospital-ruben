      ...
      <div className=" bg-blue-900">
        <div className="bg-blue-500 rounded-lg mx-auto grid grid-cols-1 lg:max-w-5xl">
          ...
          <div className="grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0">
            <img src="./public/avatar.jpg" alt="avatar" className="m-5 w-30 h-30 object-cover rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full" loading="lazy"></img>
            <img src="./public/avatar2.jpg" alt="avatar1" className="m-5 hidden w-30 h-30 object-cover rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy"></img>
            <img src="./public/avatar3.jpg" alt="avatar2" className="m-5 hidden w-30 h-30 object-cover rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy"></img>
          </div>
