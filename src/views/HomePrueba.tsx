...
export const Home =()=>{
    return(
        <div className="p-40 bg-yellow-500">
            <h2>HOME</h2>
            
            <section className="flex flex-col gap-4">
                <Medico id="1" name="Jose" surname="Gonzalez" experiencieInYears={10}/>
                <Medico id="2" name="Ana" surname="Gonzalez" experiencieInYears={5}/>
            </section>
        </div>  
    )
}
...
<div className="flex flex-wrap px-5">
          <div className="p-4">
            <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
              <h2 className="text-sm tracking-widest title-font mb-1 font-medium">Apartado1</h2>
