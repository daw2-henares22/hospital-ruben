        ...
        {/*<section className="bg-gradient-to-r from-blue-500 to-blue-900">*/}
         ...
         <div className="container mx-auto">
            ...
            <div className="mt-10 text-center font-semibold text-yellow-500 grid grid-cols-3 gap-4">
             ...
             <button onClick={()=> setShowPopup(true)}><img className="place-items-center bg-center bg-[url('./public/medicos.jpg')] p-36 ml-28 bg-cover"></img></button>
             <Popup visible={showPopup} onClose={() => setShowPopup(false)}></Popup>
              <div className="p-6">
             ...
             <button onClick={()=> setShowPopup(true)}><img className="bg-center bg-[url('./public/bioanalista.jpg')] p-36 ml-28 bg-cover"></img></button>
